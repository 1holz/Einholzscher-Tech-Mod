...
public class Registry {
    ...
    // MACHINES
    public static final RegEntry COAL_GENERATOR = new RegistryEntryBuilder().applyTemplate(RegistryTemplates.MACHINE).build("coal_generator");
    public static final RegEntry ORE_GROWER = new RegistryEntryBuilder().applyTemplate(RegistryTemplates.MACHINE).build("ore_grower");

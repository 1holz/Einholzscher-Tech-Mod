...
public class Registry {
    ...
    // MACHINES
    public static final RegEntry COAL_GENERATOR = new RegistryEntryBuilder().applyTemplate(RegistryTemplates.MACHINE).withBlockEntityBuild(CoalGeneratorBE::new).withGuiBuild(ExtendedScreenHandlerType<CoalGeneratorGui>::new, CoalGeneratorGui::init).build("coal_generator");
    public static final RegEntry ORE_GROWER = new RegistryEntryBuilder().applyTemplate(RegistryTemplates.MACHINE).withBlockEntityBuild(OreGrowerBE::new).withGuiBuild(ExtendedScreenHandlerType<OreGrowerGui>::new, OreGrowerGui::init).build("ore_grower");

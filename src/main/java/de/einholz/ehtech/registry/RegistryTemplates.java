...
public class RegistryTemplates {
    public static final Function<RegEntryBuilder, RegEntryBuilder> MACHINE = (entry) -> entry.withBlockRaw((block_entry) -> new MachineBlock(block_entry.getId(), ContainerBE::tick));
}
